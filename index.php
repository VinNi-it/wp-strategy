...
?>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-4" data-aos="fade-up">
            <h2 class="section-heading mt-3"><?php echo get_post_meta(get_the_ID(), 'what', true); ?></h2>
          </div>
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="100">

            <div class="row">
              <div class="col-md-12">
                <h2 class="mb-5"><?php echo get_post_meta(get_the_ID(), 'what-text', true); ?></h2>
              </div>
            </div>
    ...
    <section class="templateux-section mb-5">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-4" data-aos="fade-up">
            <h2 class="section-heading mt-3"><?php echo get_post_meta(get_the_ID(), 'resent', true); ?></h2>
          </div>
          <div class="col-md-8">
            <div class="row">
              <div class="col-lg-12">
              ...
              <?php 
                ...
                foreach( $posts as $post ){
                  setup_postdata($post);
                    ...
                    <div class="main-blog-wrapper" data-aos="fade-up" data-aos-delay="100">
